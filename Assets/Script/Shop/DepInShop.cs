...
public class DepInShop : MonoBehaviour
{
    ...
    private void UpdateButtonText()
    {
        ...
        if (!isUnlocked)
        {
            ...
            buttonText.text = LocalizationManager.Instance.GetLocalizedValue("buy");
            //buttonText.text = "Mua";
        ...
        else if (selectedDep == idDep.depIds.ToString())
        {
            ...
            buttonText.text = LocalizationManager.Instance.GetLocalizedValue("deselect");
        ...
        else
        {
            ...
            buttonText.text = LocalizationManager.Instance.GetLocalizedValue("choose");
    ...
    {
        // Tìm tất cả các nút dép trong scene và cập nhật trạng thái
