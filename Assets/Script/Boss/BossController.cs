...
public class BossController : MonoBehaviour
{
    ...
    //Rào cản
    public Barrier barrierController;
    //Âm thanh
    ...
    void Start()
    {
        ...
        lastAttackTime = Time.time - attackCooldown; //boss có thể tấn công ngay lập tức khi game bắt đầu
    ...
    public void TakeDamage(int damage)
    {
        if (currentState != State.Dead)
        {
            ...
            else
            {
                ...
                {
                    barrierController.DisableBarrier(); // Tắt rào cản khi boss chết
                }
            }
        }
    }
